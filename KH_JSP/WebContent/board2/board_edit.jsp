...
<form action="board_edit_post.do?id=${id}&no=${no}&pages=${pages}" method="post" enctype="multipart/form-data" name="userinput" onsubmit="return checkIt()">
...
<div class="boards_b">
	<div class="boards_bl">
		<a href="board.do?id=${id}&amp;pages=${pages}" class="btn_st"  style="margin:0 0 0 10px;">목록보기</a>
	</div>
	<div class="boards_br">
