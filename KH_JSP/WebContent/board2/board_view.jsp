...
<col width="20%" />
	<tr style="<? if($dlog[no]) {?>display:none;<? }?>">
		...
		<td style="border-top:1px solid #122942;" colspan="2"><input type="password" name="passz" value="<?=$dlog[password]?>" /></td>
	</tr>
	<tr>
		...
		<td style="width:80px;border-left:none;border-right:none;"><input type="button" onclick="submits3('<?=$_SESSION[alpau]?>');" value="등록" style="background:#d5e9ff;border:1px solid #122942;width:70px;height:45px;font-size:12px;font-weight:bold;" /></td>
	</tr>
</table>
</form>
