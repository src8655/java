...
public class Action_List extends Action_Init implements Action {
	...
	public String execute() throws ServletException, IOException {
		...
		int board_total = list_manager.getCount(searchs, searchs_value, -1, order);	//총 개수
		...
		List list = list_manager.getArticles(board_starts, board_ends, searchs, searchs_value, 10, -1, order);	//리스트받아오기
