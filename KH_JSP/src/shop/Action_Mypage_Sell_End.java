...
public class Action_Mypage_Sell_End extends Action_Init implements Action {
	...
	public String execute() throws ServletException, IOException {
		...
		int board_total = sdb.count2(member_info.getNo(), 5);	//총 개수
		...
		//리스트 가져오기
		List list = sdb.getArticles2(board_starts, board_ends, member_info.getNo(), 5);
