...
<form action="notice_edit_post.o" method="post" id="qna_write_form">
<input type="hidden" name="no" value="${ndata.no}" />
<table cellspacing="0" cellpadding="10" border="0" class="qna_write_board">
	<col width="150px" />
	<col width="500px" />
	<tr>
		<th>제목</th>
		<td><input type="text" name="subject" value="${ndata.subject}" /></td>
	</tr>
	<tr>
		<td colspan="2">
			<textarea name="memo" id="memo">${ndata.memo}</textarea>
			<script>
...
<div class="customer_center_btn" style="margin-bottom:30px;">
	<a href="#10" class="customer_center_btn1" onclick="qna_write_form.submit();">수정</a>
