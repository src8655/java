package net.myshop.data;

public class Sell_Data_Bean {
	private int no;
	...
	public String getShip_dates() {
		return ship_dates;
	}
	public void setShip_dates(String ship_dates) {
		this.ship_dates = ship_dates;
	}
	...
	public void setRmoneys(String rmoneys) {
		this.rmoneys = rmoneys;
	}
