...
<input type="hidden" name="no" value="${ldata.no}" />
  ...
  <div class="list_v_c" id="view_tab1" <c:if test="${tab ne 1}">style="display:none;"</c:if>>
  	${ldata.memo}<br />
  	<c:if test="${ldata.file2 ne ''}"><img src="./upload/${ldata.file2}" alt="${ldata.name}" /><br /></c:if>
  	<c:if test="${ldata.file3 ne ''}"><img src="./upload/${ldata.file3}" alt="${ldata.name}" /><br /></c:if>
  	<c:if test="${ldata.file4 ne ''}"><img src="./upload/${ldata.file4}" alt="${ldata.name}" /><br /></c:if>
  	<c:if test="${ldata.file5 ne ''}"><img src="./upload/${ldata.file5}" alt="${ldata.name}" /></c:if>
  </div>
